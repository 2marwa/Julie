...
def append_name():
    ...
    hire_details.append([entry_name.get(), item_var.get(), entry_hires.get(), random_receipt])
...
def setup_buttons():
    ...
    item_dropdown.config(bg="#dca2de")  # Set the background color of the dropdown menu
...
def main():
    ...
    main_window.geometry("800x400")  # Increased window width to accomadate the longer item names
